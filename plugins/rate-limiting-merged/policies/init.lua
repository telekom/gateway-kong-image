...
-- Based on: https://github.com/Kong/kong/blob/3.9.1/kong/plugins/rate-limiting/policies/init.lua
...
local function get_redis_configuration(plugin_conf)
  return {
     ...
     username = plugin_conf.redis_username,
     password = plugin_conf.redis_password,
     database = plugin_conf.redis_database,
     timeout = plugin_conf.redis_timeout,
     ssl = plugin_conf.redis_ssl,
     ssl_verify = plugin_conf.redis_ssl_verify,
     server_name = plugin_conf.redis_server_name,
  }
end
