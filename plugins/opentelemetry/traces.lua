...
-- Based on: https://github.com/Kong/kong/blob/3.9.1/kong/plugins/opentelemetry/traces.lua
-- Vendored unmodified from Kong 3.9.1 for a consistent, self-contained plugin source.
