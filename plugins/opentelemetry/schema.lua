...
-- Based on: https://github.com/Kong/kong/blob/3.9.1/kong/plugins/opentelemetry/schema.lua
      ...
      fields = {
        ...
        { propagation = typedefs.propagation {
          default = {
            ...
            -- SPDX-FileCopyrightText: 2025 Deutsche Telekom AG
            -- SPDX-License-Identifier: Apache-2.0
            -- Default to b3 propagation to preserve trace continuity with
            -- Jumper and the Tardis trace id flow across the mesh.
            default_format = "b3",
            -- SPDX-SnippetEnd
          },
        } },
